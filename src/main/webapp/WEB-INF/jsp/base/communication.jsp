				...
				<p>
					<div id="myDialog"> 
	    				...
	    				<div class="bd"> 
	        				...
	        				<form:form name="dlgForm" method="POST" action="communication.html" modelAttribute="communication"> 

            					<p>Communication XML Ersellen</p> 

	            				<label for="ibus">iBus Proxy Service Url</label>
	            				<form:input path="busProxyServiceUrl" /> 
	            				...
	            				<label for="name">Eigene Proxy Service Url</label>
	            				<form:input path="proxyServiceUrl" /> 
